...
our $QEMU_BIN     = $ENV{AMENT_QEMU_BIN}     || do {my $path = `which qemu`; chomp $path; $path};
our $QEMU_IMG_BIN = $ENV{AMENT_QEMU_IMG_BIN} || do {my $path = `which qemu-img`; chomp $path; $path};
